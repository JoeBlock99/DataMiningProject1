...
nac_por_dpto_edades_simples %>% filter(Edad != "Todas las edades") %>% select(-2) %>% plot_intro()

# 2.0 Missing Values

nac_por_dpto_edades_simples %>% filter(Edad != "Todas las edades") %>% select(-2) %>% profile_missing()

# 3.0 Continuos Features

nac_por_dpto_edades_simples %>% filter(Edad != "Todas las edades") %>% select(-2) %>% plot_density()
nac_por_dpto_edades_simples %>% filter(Edad != "Todas las edades") %>% select(-2) %>% plot_histogram()

# 4.0 Categorical Features

#nac_por_dpto_edades_simples %>% filter(Edad != "Todas las edades") %>% select(-2) %>% plot_prcomp()
# nac_por_dpto_edades_simples %>% filter(Edad != "Todas las edades") %>% select(-2) %>% plot_bar()
nac_por_dpto_edades_simples %>% filter(Edad != "Todas las edades") %>% select(-2) %>% plot_qq()
nac_por_dpto_edades_simples %>% filter(Edad != "Todas las edades") %>% select(-2) %>% plot_boxplot(by="anio")
#nac_por_dpto_edades_simples %>% filter(Edad != "Todas las edades") %>% select(-2) %>% plot_scatterplot(by="Edad")

# 5.0 Relationships

# nac_por_dpto_edades_simples %>% filter(Edad != "Todas las edades") %>% select(-2) %>% plot_correlation()
...
nac_por_dpto %>% filter(Mes != "Todos los meses") %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% select(-3) %>% plot_intro()

# 2.0 Missing Values

nac_por_dpto %>% filter(Mes != "Todos los meses") %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% select(-3) %>% profile_missing()

# 3.0 Continuos Features

nac_por_dpto %>% filter(Mes != "Todos los meses") %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% select(-3) %>% plot_density()
nac_por_dpto %>% filter(Mes != "Todos los meses") %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% select(-3) %>% plot_histogram()

# 4.0 Categorical Features

nac_por_dpto %>% filter(Mes != "Todos los meses") %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% select(-3) %>% plot_bar()

nac_por_dpto %>% filter(Mes != "Todos los meses") %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% select(-3) %>% plot_qq()
nac_por_dpto %>% filter(Mes != "Todos los meses") %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% select(-3) %>% plot_boxplot(by="anio")

# 5.0 Relationships

# nac_por_dpto %>% filter(Mes != "Todos los meses") %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% select(-3) %>% plot_correlation()
...
nac_por_estado_civil %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% select(-2) %>% plot_intro()

# 2.0 Missing Values

nac_por_estado_civil %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% select(-2) %>% profile_missing()

# 3.0 Continuos Features

nac_por_estado_civil %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% select(-2) %>% plot_density()
nac_por_estado_civil %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% select(-2) %>% plot_histogram()

# 4.0 Categorical Features

nac_por_estado_civil %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% select(-2) %>% plot_bar()
nac_por_estado_civil %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% select(-2) %>% plot_qq(by="anio")
nac_por_estado_civil %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% select(-2) %>% plot_boxplot(by="anio")

# 5.0 Relationships

nac_por_estado_civil %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% select(-2) %>% plot_correlation()
...
nac_por_estado_civil_por_edad %>% filter(Grupos.de.edad != "Todas las edades") %>% select(-2) %>% plot_intro()

# 2.0 Missing Values

nac_por_estado_civil_por_edad %>% filter(Grupos.de.edad != "Todas las edades") %>% select(-2) %>% profile_missing()

# 3.0 Continuos Features

nac_por_estado_civil_por_edad %>% filter(Grupos.de.edad != "Todas las edades") %>% select(-2) %>% plot_density()
nac_por_estado_civil_por_edad %>% filter(Grupos.de.edad != "Todas las edades") %>% select(-2) %>% plot_histogram()

# 4.0 Categorical Features

nac_por_estado_civil_por_edad %>% filter(Grupos.de.edad != "Todas las edades") %>% select(-2) %>% plot_bar()
nac_por_estado_civil_por_edad %>% filter(Grupos.de.edad != "Todas las edades") %>% select(-2) %>% plot_qq(by="anio")
nac_por_estado_civil_por_edad %>% filter(Grupos.de.edad != "Todas las edades") %>% select(-2) %>% plot_boxplot(by="anio")

# 5.0 Relationships

nac_por_estado_civil_por_edad %>% filter(Grupos.de.edad != "Todas las edades") %>% select(-2) %>% plot_correlation()
...
nac_por_estado_civil_padre_por_edad %>% filter(Grupos.de.edad != "Todas las edades") %>% select(-2) %>% introduce()
nac_por_estado_civil_padre_por_edad %>% filter(Grupos.de.edad != "Todas las edades") %>% select(-2) %>% plot_intro()

# 2.0 Missing Values

nac_por_estado_civil_padre_por_edad %>% filter(Grupos.de.edad != "Todas las edades") %>% select(-2) %>% profile_missing()

# 3.0 Continuos Features

nac_por_estado_civil_padre_por_edad %>% filter(Grupos.de.edad != "Todas las edades") %>% select(-2) %>% plot_density()
nac_por_estado_civil_padre_por_edad %>% filter(Grupos.de.edad != "Todas las edades") %>% select(-2) %>% plot_histogram()

# 4.0 Categorical Features

nac_por_estado_civil_padre_por_edad %>% filter(Grupos.de.edad != "Todas las edades") %>% select(-2) %>% plot_bar()
nac_por_estado_civil_padre_por_edad %>% filter(Grupos.de.edad != "Todas las edades") %>% select(-2) %>% plot_qq(by="anio")
nac_por_estado_civil_padre_por_edad %>% filter(Grupos.de.edad != "Todas las edades") %>% select(-2) %>% plot_boxplot(by="anio")

# 5.0 Relationships

nac_por_estado_civil_padre_por_edad %>% filter(Grupos.de.edad != "Todas las edades") %>% select(-2) %>% plot_correlation()
...
nac_edad_madre_departamento_municipio %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% filter(Municipios != "Todos los municipios") %>% select(-3) %>% plot_intro()

# 2.0 Missing Values

nac_edad_madre_departamento_municipio %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% filter(Municipios != "Todos los municipios") %>% select(-3) %>% profile_missing()

# 3.0 Continuos Features

nac_edad_madre_departamento_municipio %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% filter(Municipios != "Todos los municipios") %>% select(-3) %>% plot_density()
nac_edad_madre_departamento_municipio %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% filter(Municipios != "Todos los municipios") %>% select(-3) %>% plot_histogram()

# 4.0 Categorical Features

nac_edad_madre_departamento_municipio %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% filter(Municipios != "Todos los municipios") %>% select(-3) %>% plot_bar()

# 5.0 Relationships

nac_edad_madre_departamento_municipio %>% filter(Departamento.de.residencia != "Todos los departamentos") %>% filter(Municipios != "Todos los municipios") %>% select(-3) %>% plot_correlation()
...
nac_edad_madre_ocupacion %>% filter(Grupos.ocupacionales != "Todos los grupos ocupacionales") %>% select(-2) %>% plot_intro()

# 2.0 Missing Values

nac_edad_madre_ocupacion %>% filter(Grupos.ocupacionales != "Todos los grupos ocupacionales") %>% select(-2) %>% profile_missing()

# 3.0 Continuos Features

nac_edad_madre_ocupacion %>% filter(Grupos.ocupacionales != "Todos los grupos ocupacionales") %>% select(-2) %>% plot_density()
nac_edad_madre_ocupacion %>% filter(Grupos.ocupacionales != "Todos los grupos ocupacionales") %>% select(-2) %>% plot_histogram()

# 4.0 Categorical Features

nac_edad_madre_ocupacion %>% filter(Grupos.ocupacionales != "Todos los grupos ocupacionales") %>% select(-2) %>% plot_bar()

# 5.0 Relationships

# nac_edad_madre_ocupacion %>% filter(Grupos.ocupacionales != "Todos los grupos ocupacionales") %>% select(-2) %>% plot_correlation()
...
nac_edad_madre_depto_area_etnia %>% filter(Departamento.de.ocurrencia != "Todos los departamentos") %>% filter(Pueblo.de.pertenencia.de.la.madre != "Todos los grupos étnicos") %>% select(-3) %>% plot_intro()

# 2.0 Missing Values

nac_edad_madre_depto_area_etnia %>% filter(Departamento.de.ocurrencia != "Todos los departamentos") %>% filter(Pueblo.de.pertenencia.de.la.madre != "Todos los grupos étnicos") %>% select(-3) %>% profile_missing()

# 3.0 Continuos Features

nac_edad_madre_depto_area_etnia %>% filter(Departamento.de.ocurrencia != "Todos los departamentos") %>% filter(Pueblo.de.pertenencia.de.la.madre != "Todos los grupos étnicos") %>% select(-3) %>% plot_density()
nac_edad_madre_depto_area_etnia %>% filter(Departamento.de.ocurrencia != "Todos los departamentos") %>% filter(Pueblo.de.pertenencia.de.la.madre != "Todos los grupos étnicos") %>% select(-3) %>% plot_histogram()

# 4.0 Categorical Features

nac_edad_madre_depto_area_etnia %>% filter(Departamento.de.ocurrencia != "Todos los departamentos") %>% filter(Pueblo.de.pertenencia.de.la.madre != "Todos los grupos étnicos") %>% select(-3) %>% plot_bar()

# 5.0 Relationships

nac_edad_madre_depto_area_etnia %>% filter(Departamento.de.ocurrencia != "Todos los departamentos") %>% filter(Pueblo.de.pertenencia.de.la.madre != "Todos los grupos étnicos") %>% select(-3) %>% plot_correlation()
...
nac_escolaridad_madre %>% filter(Número.de.hijos.as. != "Todos los hijos") %>% select(-2) %>% plot_intro()

# 2.0 Missing Values

nac_escolaridad_madre %>% filter(Número.de.hijos.as. != "Todos los hijos") %>% select(-2) %>% profile_missing()

# 3.0 Continuos Features

nac_escolaridad_madre %>% filter(Número.de.hijos.as. != "Todos los hijos") %>% select(-2) %>% plot_density()
nac_escolaridad_madre %>% filter(Número.de.hijos.as. != "Todos los hijos") %>% select(-2) %>% plot_histogram()

# 4.0 Categorical Features

nac_escolaridad_madre %>% filter(Número.de.hijos.as. != "Todos los hijos") %>% select(-2) %>% plot_bar()
nac_escolaridad_madre %>% filter(Número.de.hijos.as. != "Todos los hijos") %>% select(-2) %>% plot_qq(by="anio")
nac_escolaridad_madre %>% filter(Número.de.hijos.as. != "Todos los hijos") %>% select(-2) %>% plot_boxplot(by="anio")

# 5.0 Relationships

nac_escolaridad_madre %>% filter(Número.de.hijos.as. != "Todos los hijos") %>% select(-2) %>% plot_correlation()
